@extends('welcome')
@section('title', '| commetarrondissement')
        ...
        <div class="card-header">LISTE D'ENREGISTREMENT DES CENTRES DE VOTES</div>
            <div class="card-body">
                ...
                <table id="datable_3" class="table table-hover w-100 display">
                    <thead>
                        <tr>
                            <th>Commune et Departement</th>
                            <th>Arrondissement</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach ($commetarrondissements as $commetarrondissement)
                        <tr>
...
<div class="modal fade" id="exampleModalform2" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('importer.commetarrondissement') }}" method="POST" enctype="multipart/form-data">
                @csrf
